...
namespace DesignPatterns\ObserverPatternPush\Tests;

use DesignPatterns\ObserverPatternPush\Data\WeatherData;
use DesignPatterns\ObserverPatternPush\Displays\CurrentConditionWeatherDisplay;
use DesignPatterns\ObserverPatternPush\Displays\ForecastWeatherDisplay;
use DesignPatterns\ObserverPatternPush\Displays\StatisticsWeatherDisplay;
...
class DisplayTest extends TestCase
{
    ...
    {
        $weather_data = $this->getWeatherData();
        $display = new CurrentConditionWeatherDisplay();
    ...
    {
        $weather_data = $this->getWeatherData();
        $display = new ForecastWeatherDisplay();
    ...
    {
        $weather_data = $this->getWeatherData();
        $display = new StatisticsWeatherDisplay();
